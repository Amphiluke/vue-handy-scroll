<template>
  <section id="demo-handscrolls">
    ...
    <div>
      ...
      <HandyScroll class="handscrolls" ref="handscrolls" :unobtrusive="unobtrusive">
        <img
...
&lt;script&gt;
  ...
  export default {
    ...
    watch: {
      handscroll() {
        <span class="hs-highlight">EventBus.$emit(&quot;update&quot;, this.$refs.handscrolls.$el);</span>
      }
    }
  };
&lt;/script&gt;</pre>
  ...
  export default {
        ...
        handscrolls: [
          {
            ...
            src: require("../assets/images/along-the-river.jpg"),
            width: 10561,
            height: 1000
          },
          {
            ...
            src: require("../assets/images/nine-dragons.jpg"),
            width: 19039,
            height: 964
          },
          {
            ...
            src: require("../assets/images/emperor-tour.jpg"),
            width: 3001,
            height: 1396
          }
        ]
    ...
    watch: {
      handscroll() {
        ...
        this.$nextTick(() => hsEl.scrollLeft = hsEl.scrollWidth);
        EventBus.$emit("update", hsEl);
      }
    },
    mounted() {
      let hsEl = this.$refs.handscrolls.$el;
